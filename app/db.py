...
def up():
  ...
  createTable(unusedMessagesTableName)
  createTable(usedMessagesTableName)
...
def createTable(tableName):
  ...
  try:
    ...
    if (e.response['Error']['Code'] != 'ResourceInUseException'): raise e
  return

def down():
  """Tears down the database, deletes all the tables this project uses."""
  deleteTable(usedMessagesTableName)
  deleteTable(unusedMessagesTableName)
